...
feature_bn=np.load('data/PCA_visualization/expr/feature_before_{}.npy'.format(add))
feature_an=np.load('data/PCA_visualization/expr/feature_after_{}.npy'.format(add))
label_bn=np.load('data/PCA_visualization/expr/reg_label.npy')
...
if 1:
    ...
    #plt.show()
    fig.savefig('expr_{}2.svg'.format(add))
    fig.clear()
