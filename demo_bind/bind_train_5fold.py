...
if __name__ == '__main__':
    ...
    feats=np.load('data/QuickStart/data/single_bind_customize_train_data.npy')
    reg_label=np.load('data/QuickStart/data/single_bind_customize_train_label.npy').reshape(-1,1)
