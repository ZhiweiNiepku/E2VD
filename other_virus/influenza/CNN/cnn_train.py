...
if __name__ == '__main__':
    ...
    res_dir = "result_cnn_{}_lr{}_k{}_f1_prop".format(BATCH_SIZE,lr,k)
    ...
    feats=np.load('data/other_virus/influenza/CNN/onehot_train_data.npy')
    reg_label=np.load('data/other_virus/influenza/CNN/onehot_train_label.npy').reshape(-1,1)
    
    cls_label=(reg_label>0)
