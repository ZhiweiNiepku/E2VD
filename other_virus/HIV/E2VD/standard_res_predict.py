...
if __name__ == '__main__':
    ...
    if 1:
        # load train data
        train_feats=np.load('data/other_virus/HIV/E2VD/train_data.npy')
        ...
        # load test data
        test_feats=np.load('data/other_virus/HIV/E2VD/test_data.npy')
        test_reg_label=np.load('data/other_virus/HIV/E2VD/test_label.npy') / 10
