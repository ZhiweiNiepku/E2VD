...
if __name__ == '__main__':
    ...
    feats=np.load('data/other_virus/HIV/E2VD/train_data.npy')
    reg_label=np.load('data/other_virus/HIV/E2VD/train_label.npy').reshape(-1,1) / scaling
