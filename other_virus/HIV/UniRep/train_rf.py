...
if __name__ == '__main__':
    ...
    feats=np.load('data/other_virus/HIV/unirep/1900_train_data.npy')
    reg_label=np.load('data/other_virus/HIV/unirep/1900_train_label.npy').reshape(-1,1) / 10
    ...
    # load test data
    test_feats=np.load('data/other_virus/HIV/unirep/1900_test_data.npy')
    test_reg_label=np.load('data/other_virus/HIV/unirep/1900_test_label.npy') / 10
