...
if __name__ == '__main__':
    ...
    res_dir = "result_noM_noLG_{}_a{}_lr{}_regk{}_k{}_f1_prop_loss_".format(BATCH_SIZE,cls_alpha,lr,REG_LOSS_K,k)
    ...
    feats=np.load('<path to data>/single_bind_{}_train_data.npy'.format(BACKBONE))
    reg_label=np.load('<path to data>/single_bind_{}_train_label.npy'.format(BACKBONE)).reshape(-1,1)
