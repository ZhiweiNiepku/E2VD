...
class BertPreTraining(nn.Cell):
    ...
    def construct(self, input_ids, input_mask, masked_lm_positions):
...
class BertNetworkWithLoss(nn.Cell):
    ...
    def construct(self,
        ...
        prediction_scores = self.bert(input_ids, input_mask, masked_lm_positions)
...
class BertPretrainEval(nn.Cell):
    ...
    def construct(self,
        ...
        mlm, _ = self.network(input_ids, input_mask, masked_lm_positions)
