...
class babbler1900():
    ...
    def __init__(self,
        ...
        logits_flat = tf.compat.v1.layers.dense(
            flat, self._vocab_size - 1, activation=None,
            kernel_initializer=tf.constant_initializer(np.load(os.path.join(self._model_path, "fully_connected_weights:0.npy"))),
            bias_initializer=tf.constant_initializer(np.load(os.path.join(self._model_path, "fully_connected_biases:0.npy"))))
    ...
    def get_rep(self,seq):
        ...
        with tf.compat.v1.Session() as sess:
            ...
            # print("Available GPU devices:", devices)
