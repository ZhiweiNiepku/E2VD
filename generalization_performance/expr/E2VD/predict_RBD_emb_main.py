...
if __name__ == '__main__':
    ...
    test_data_path='<path to data>/multi_customize_all_data.npy'
    add_='expr_embedding_all_data'
    ...
    if 1:
        ...
        train_label=np.concatenate([label1,label2],axis=0).flatten()
        train_feats=train_feats[train_label!=1]
