...
#HSEQ_emb=np.load('data/antibody_heavy_sequence_embedding_all_data.npy')
#LSEQ_emb=np.load('data/antibody_light_sequence_embedding_all_data.npy')
...
if __name__ == '__main__':
    ...
    res_dir = "result_onehot_large_{}_lr{}_regk{}_k{}_f1_prop_loss_".format(BATCH_SIZE,lr,REG_LOSS_K,k)
