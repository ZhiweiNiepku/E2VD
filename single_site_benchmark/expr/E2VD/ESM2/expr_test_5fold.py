...
class SoluModel(nn.Module):
    def __init__(self, seq_len ,in_dim=5120, sa_out=5120, conv_out=5120):
...
if __name__ == '__main__':
    ...
    if 1:
        # load train data
        train_feats=np.load('<path to data>/single_expr_esm2_train_data.npy')
        ...
        # load test data
        test_feats=np.load('<path to data>/single_expr_esm2_test_data.npy')
        test_reg_label=np.load('<path to data>/single_expr_esm2_test_label.npy')
