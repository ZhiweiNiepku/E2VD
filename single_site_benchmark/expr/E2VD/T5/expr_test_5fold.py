...
if __name__ == '__main__':
    ...
    if 1:
        # load train data
        train_feats=np.load('<path to data>/single_expr_t5_train_data.npy')
        ...
        # load test data
        test_feats=np.load('<path to data>/single_expr_t5_test_data.npy')
        test_reg_label=np.load('<path to data>/single_expr_t5_test_label.npy')
