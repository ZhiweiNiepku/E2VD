#进行归一化，85backbone，CPP+CNN 5*55交叉验证训练代码
...
if __name__ == '__main__':
    ...
    feats=np.load('<path to data>/single_expr_esm1v_train_data.npy')
    reg_label=np.load('<path to data>/single_expr_esm1v_train_label.npy').reshape(-1,1)
