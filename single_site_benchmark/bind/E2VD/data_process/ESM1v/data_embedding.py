...
print(res.shape)
np.save('<path to save data>/single_bind_esm1v_train_data.npy',res)
np.save('<path to save data>/single_bind_esm1v_train_label.npy',labels)
...
print(res.shape)
np.save('<path to save data>/single_bind_esm1v_test_data.npy',res)
np.save('<path to save data>/single_bind_esm1v_test_label.npy',labels)