...
if __name__ == '__main__':
    ...
    res_dir = "result_{}{}_a{}_lr{}_regk{}_k{}_f1_prop_".format(BATCH_SIZE,add_,cls_alpha,lr,REG_LOSS_K,k)
    ...
    feats=np.load('<path to data>/mine_rare_train_data.npy')
    reg_label=np.load('<path to data>/mine_rare_train_label.npy').reshape(-1,1)
